...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active"><a href="<?php echo base_url()."assets/"; ?>#"><i class="fa fa-link"></i> <span>Link</span></a></li>
        <li><a href="<?php echo base_url()."assets/"; ?>#"><i class="fa fa-link"></i> <span>Another Link</span></a></li>
        <li class="treeview">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url()."assets/"; ?>#"><i class="fa fa-dashboard"></i> Level</a></li>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2016 <a href="<?php echo base_url()."assets/"; ?>#">Company</a>.</strong> All rights reserved.
  </footer>
